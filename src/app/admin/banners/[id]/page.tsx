          ...
          <div className="mb-8">
            ...
            <Card className="border border-gray-300">
              <CardContent className="p-8 space-y-8">
                ...
                {/* Ordenação */}
                <div className="flex items-center gap-8">
                  <Label className="text-gray-700 font-medium w-24">Ordenação:</Label>
                  <Select
                    value={bannerData.order}
                    onValueChange={(value) => setBannerData({ ...bannerData, order: value })}
                  >
                ...
                <div className="flex items-start gap-8">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">(JPG/PNG 1920x750px)</p>
                  </div>
                </div>
